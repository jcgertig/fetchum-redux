(function (global, factory) {
  ...
  var generatePagedCalls = function generatePagedCalls() {
    var baseUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var idVar = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'id';
    var token = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var name = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'FETCH';
      ...
      getPage: function getPage(page, params, body, headers, customToken, tokenType) {
        return function (dispatch) {
          ...
          return dispatch(generateRequest({
            ...
            method: 'GET',
            route: baseUrl
          }, '' + pagePre + name)(params, _extends({}, body, { page: nextPage }), headers, customToken, tokenType));
        };
      },
  ...
  var generateCRUDReducer = function generateCRUDReducer(_ref) {
  ...
  var request = function request(isFormData, method, url, body, headers, others) {
  ...
  var apiRequest = function apiRequest(isFormData, method, route, body, headers, others) {
    var name = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'FETCH';
    return function (dispatch) {
      return new Promise(function (accept, reject) {
        dispatch({
  ...
  var methods = {
    ...
    generateCRUDRequests: generateCRUDRequests,
    generatePagedCalls: generatePagedCalls,
    generateCRUDReducer: generateCRUDReducer,
    request: request,
